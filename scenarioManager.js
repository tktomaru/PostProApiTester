 ...
 */
export async function insertRequestIntoScenario(scenarioId, insertIndex) {
    const scenario = state.scenarios.find(s => s.id === scenarioId);
    if (!scenario) {
 ...
 */
export function renderScenarioRequests(scenarioId) {
    const container = document.getElementById('scenarioRequestsList');
    container.innerHTML = '';
 ...
 */
async function moveRequestInScenario(scenarioId, fromIndex, toIndex) {
    const scenario = state.scenarios.find(s => s.id === scenarioId);
    if (!scenario) return;
 ...
 */
async function deleteRequestFromScenario(scenarioId, requestIndex) {
    const scenario = state.scenarios.find(s => s.id === scenarioId);
    if (!scenario) return;
 ...
 */
export async function addRequestToScenario(req) {
...
export async function runScenario() {
    ...
    const resultContainer = document.getElementById('scenarioResultContainer');
